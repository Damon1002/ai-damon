...
const Home: NextPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-1 ">
      <Head>
        <title>HUA's Ai </title>
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className="flex flex-col w-1/3 items-center justify-center">
        <h1 className="mt-3 mb-10 font-extrabold text-transparent text-5xl bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-500">
          HUA's Ai
        </h1>
        ...
        <div className="relative w-full">
          ...
          <textarea
            ...
            rows={4}
            className="block p-2.5 w-full text-xl text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-cyan-500 focus:border-cyan-500"
        ...
        <button
          type="button"
          onClick={submit}
          className="my-5 w-1/3 text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
        >
          {loading ? (
